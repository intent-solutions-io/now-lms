...
| REQ-002 | Applicant confirmation email is best-effort: mail unavailability never loses the DB row | MUST | ADR-4, 011-PP-PLAN §notification | `tests/test_request_access.py`, `features/request_access.feature` |
