...
| [015-AT-ADEC-short-answer-evaluations.md](015-AT-ADEC-short-answer-evaluations.md) | ADR-6 (2026-07-28, **Proposed**): add a `short_answer` question type with written-response storage, a per-question rubric, and an instructor grading queue — authored upstream per ADR-1. Automated grading explicitly out of scope. Awaiting a ruling. |
...
| ADR-6 | [015](015-AT-ADEC-short-answer-evaluations.md) | 2026-07-28 | **Proposed** | Add a `short_answer` question type with instructor grading, authored upstream |
