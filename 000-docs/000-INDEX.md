...
| ADR-8 | [015](015-AT-ADEC-community-hub-storage.md) | 2026-08-08 | **Superseded by ADR-10** | Community Hub on native `foro_mensaje` bodies and replies, plus three sidecar tables for metadata, likes and the moderation trail |
...
| ADR-10 | [017](017-AT-ADEC-community-hub-owns-its-content.md) | 2026-08-09 | Accepted | The Community Hub owns its posts and replies; no container course. Supersedes ADR-8 |
